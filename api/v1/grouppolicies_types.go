...
type GroupPoliciesSpec struct {
	...
	// Foo is an example field of GroupPolicies. Edit grouppolicies_types.go to remove/update
...
// GroupPolicies is the Schema for the grouppolicies API.
type GroupPolicies struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   GroupPoliciesSpec   `json:"spec,omitempty"`
	Status GroupPoliciesStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// GroupPoliciesList contains a list of GroupPolicies.
